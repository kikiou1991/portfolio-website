  ...
  return (
    <div className='w-full md:w-[30%] h-full '>
        <div className="h-52 md:h-72 rounded-t-xl relative group"
            ...
            <div className='overlay aspect-w-1 aspect-h-1 rounded-t-xl items-center justify-center absolute top-0 left-0 w-full h-full bg-[#181818] bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-80 transition-all duration-500'>
        ...
        <div className='text-white rounded-b-xl bg-[#181818] py-6 px-4 aspect-w-1 aspect-h-1'> 
