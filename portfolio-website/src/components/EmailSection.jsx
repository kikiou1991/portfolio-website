        ...
        {emailSubmitted ? (
          ...
          <form
            ...
            <div className='mb-2 w-full'>
              ...
              <input name='senderEmail' type='email' required maxLength={500} placeholder='Your email' className='bg-[#1819E] w-full border border-[#33353F] rounded-lg  p-3' />
            </div>
            <div className='mb-2 w-full'>
              <label htmlFor='subject' typeof='email' className='text-white w-full block text-sm font-medium mb-2'>
                Subject
              </label>
              <input name='subject' type='text' id='subject' required className='bg-[#1819E] border border-[#33353F] w-full rounded-lg p-2.5' />
            </div>
            <div className='mb-6 w-full'>
              <label htmlFor='message' className='text-white block text-sm mb-2 font-medium'>
                Message
              </label>
              <textarea name='message' placeholder='Your message' required maxLength={5000} className='bg-[#1819E] border border-[#33353F] w-full rounded-lg h-52 p-2.5'></textarea>
            </div>
